...
Scenario: successfully logging in
    ...
    And   I can see a request for my restaurants email
    And   I can see a request for the accounts password
    And   my restaurant is registered to the system with the email "atlantico@gmail.com" with the password "CkRGTXN7"
    When  I enter my restaurants email 'atlantico@gmail.com' with the password 'CkRGTXN7'
    Then  I am now at my restaurants home screen


 Scenario: successfully logging out

     Given I am logged in to the system with the email "atlantico@gmail.com"
     And   I am in my restaurants home screen
     When  I open my profile options
     And   I click the option to log out of the system
 ...
 Scenario: invalid data on login
     ...
     And   I can see a request for my restaurants email
     And   I can see a request for the accounts password
     When  I enter my restaurants email '12345678@gmail.com' with the password 'atlantico123'
